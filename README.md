...
O **LiteCOPASAelevatoria** é um sistema de monitoramento remoto desenvolvido para sistemas de elevação de água. O projeto baseia-se em um microcontrolador ESP32 que realiza a leitura de parâmetros físicos por meio de conversores , e leitura de sensores dedicados do projeto, e transmite os dados via telemetria utilizando o protocolo MQTT sobre uma rede móvel.
